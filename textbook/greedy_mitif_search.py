...
# -*- coding: utf-8 -*-
"""
Created on Wed Oct 14 00:30:52 2020
...
def get_profile_mat(dna_list):
    ...
    for i in range(k):
        ...
        for dna,val in count.items():
            profile_mat[mapper[dna]][i] = val/len(dna_list)
    return profile_mat
...
# file_path = 'sample_data/greedy_motif_search2.txt'
file_path = 'test_data/dataset_159_5.txt'
dna_strs,k,t = read_file(file_path)
best_motifs,best_score = greedyMotifSearch(dna_strs, k, t)
print(best_score)
